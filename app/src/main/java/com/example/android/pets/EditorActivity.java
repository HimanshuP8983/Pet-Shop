...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void savePet() {
        ...
        if(mCurrentPetUri == null){
            // This is a NEW pet, so insert into provider,
            ...
            // Show a toast message depending on whether or not the update successful.
            if(rowsAffected == 0){
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        //Since the editor shows all pet attributes, define a projection that all
